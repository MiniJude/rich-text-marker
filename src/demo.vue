<template>
  ...
  let case2 = '<p>这是一道问答题，你需要仔细读题。如果不是题目中有明确要求，请尽量使用键盘作答。回答问答题时需要逻辑清晰，用词准确。如果题干要求拍照上传答案，例如画一个sin(x)的曲线。你需要点击输入框下方的相机图标<img src="data:image/png;base64,">，如果此时你的手机已经处于本场考试的监考模式下，你的手机上会自动进入拍照模式，将镜头对准要拍摄的内容，按照网页的提示进行拍照上传。</p><p>如果你的手机没有连接本场考试，你需要用手机扫码弹出的二维码。下面请填写一个简短的自我介绍，并添加自己将要用于答题的电脑设备的照片（1~3张照片）。</p>'
